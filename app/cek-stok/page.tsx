...
export default function CekStokPage() {
  ...
  // Only Available Stock toggle state
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <label className="flex items-center gap-2 cursor-pointer bg-white hover:bg-slate-50 px-3 py-2 rounded-xl border border-slate-200/80 transition-all select-none shadow-sm">
            <input
              type="checkbox"
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between text-xs font-bold text-slate-500">
          <span>Menampilkan {filteredProducts.length} produk ditemukan</span>
        </div>
